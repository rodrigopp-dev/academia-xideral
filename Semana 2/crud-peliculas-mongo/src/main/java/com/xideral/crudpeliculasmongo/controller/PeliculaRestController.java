package com.xideral.crudpeliculasmongo.controller;
...
import com.xideral.crudpeliculasmongo.service.PeliculaService;
...
public class PeliculaRestController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Pelicula> updatePalicula(@PathVariable String id, @RequestBody Pelicula pelicula) {
	...
	@PatchMapping("/{id}")
	public ResponseEntity<Pelicula> updateParcialPalicula(@PathVariable String id, @RequestBody Map<String, Object> camposActualizar) {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Void> deletePelicula(@PathVariable String id) {
		Optional<Pelicula> pelicula = service.findById(id);
		if (pelicula.isPresent()) {
