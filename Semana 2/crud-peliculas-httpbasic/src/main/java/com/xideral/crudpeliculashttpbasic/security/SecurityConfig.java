package com.xideral.crudpeliculashttpbasic.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(configurer -> configurer
                ...
                .requestMatchers(HttpMethod.GET, "/api/peliculas").hasRole("EMPLOYEE")
                .requestMatchers(HttpMethod.GET, "/api/peliculas/**").hasRole("EMPLOYEE")
                // crear y modificar: solo managers
                .requestMatchers(HttpMethod.POST, "/api/peliculas").hasRole("MANAGER")
                .requestMatchers(HttpMethod.PUT, "/api/peliculas/**").hasRole("MANAGER")
                .requestMatchers(HttpMethod.PATCH, "/api/peliculas/**").hasRole("MANAGER")
                // borrar: solo admins
